# ==============================================================================
# Script Name: 16_SPEC.ps1
# Description: Automated Hardware Inventory & Asset Discovery Tool.
...
# --- 5. EXPORT ---
$FileName = "Inventory_$($BranchName)_$($env:COMPUTERNAME)_$(Get-Date -Format 'yyyyMMdd').csv"
$FullExportPath = Join-Path $PSScriptRoot $FileName

$Report | Export-Csv -Path $FullExportPath -NoTypeInformation -Encoding UTF8

Write-Host "`n===============================================" -ForegroundColor Green
Write-Host "         INVENTORY COLLECTION SUCCESS          " -ForegroundColor White -BackgroundColor DarkGreen
Write-Host "===============================================" -ForegroundColor Green
Write-Host "File Exported to: $FileName" -ForegroundColor Gray
Write-Host "-----------------------------------------------"
Write-Host "RAM Detected: $RAM_Details"
Write-Host "Storage:      $DiskInfo"
Write-Host "===============================================" -ForegroundColor Green
Pause